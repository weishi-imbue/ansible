            ...
            for collection_req in file_requirements.get('collections') or []:
                if isinstance(collection_req, dict):
                    ...
                    if req_type == 'git' or req_scm == 'git':
                        ...
                        if req_src:
                            req_name = req_src
                    elif req_src and (req_src.endswith('.git') or '.git#' in req_src or req_src.startswith('git@') or req_src.startswith('git+')):
                        req_type = 'git'
                        req_name = req_src
                    elif req_name and (req_name.endswith('.git') or '.git#' in req_name or req_name.startswith('git@') or req_name.startswith('git+')):
                        req_type = 'git'
