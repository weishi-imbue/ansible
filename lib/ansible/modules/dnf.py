...
try:
    ...
    if not has_respawned():
        ...
        compatible_interpreter = probe_interpreters_for_module(interpreters, 'dnf')
    ...
    def _ensure_dnf(self):
        if not HAS_DNF:
            ...
            try:
                ...
                attempted_interpreters = ['/usr/libexec/platform-python', '/usr/bin/python3', '/usr/bin/python2', '/usr/bin/python']
                self.module.fail_json(
